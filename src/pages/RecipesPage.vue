        ...
        <template v-for="(group, gi) in visibleGroups" :key="group.title">
          <div :class="['ing-group', group.wide ? 'ing-group-wide' : '']">
            <div class="ing-group-title-row">
              ...
              <a v-if="gi === 0" href="#" class="recipes-section-link" @click.prevent="showAllGroups = !showAllGroups">
                {{ showAllGroups ? 'Hide' : 'Show all' }}
              </a>
            </div>
=======
  ...
  <nav class="bottom-nav">
    <div class="bottom-nav-inner">
      <a href="index.html" class="bottom-nav-item active">
        <img :src="$img('images/Icons/home.svg')" alt="Home" width="24" height="24">
      </a>
      <a href="#" class="bottom-nav-item">
        <img :src="$img('images/Icons/save.svg')" alt="Saved" width="24" height="24">
      </a>
    </div>
